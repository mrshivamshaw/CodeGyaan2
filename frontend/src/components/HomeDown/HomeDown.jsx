  ...
  return (
    <div className='w-full py-5'>
        <div className='w-[95%] md:w-[95%] lg:w-[85%] xl:w-[85%] mx-auto flex flex-col md:flex-row lg:flex-row xl:flex-row gap-4 justify-between items-center'>
            <div className='flex w-full lg:w-[20%] md:w-[20%] xl:w-[20%]  justify-start items-start gap-3 bg-black-bg px-4 py-4 md:py-2 lg:py-2 xl:py-2 rounded-lg text-white shadow-md shadow-black/40'>
                <div>
