...
const VideoDetails = () => {
  ...
  return (
    <div className="flex flex-col gap-5 text-white profile pt-1">
      {!videoData ? (
        <img
          src={previewSource}
          alt="Preview"
      ...
      <h1 className="mt-4 text-3xl font-semibold px-3">{videoData?.title}</h1>
      <p className="pt-2 pb-6 px-3">{videoData?.description}</p>
    </div>
  );
};
