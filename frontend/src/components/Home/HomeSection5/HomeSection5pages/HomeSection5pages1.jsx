...
const HomeSection5pages1 = () => {
  return (
    <div className="min-w-[100%] h-[100vh] md:h-auto lg:h-[100vh] xl:h-[100vh] flex flex-col-reverse md:flex-col-reverse lg:flex-row xl:flex-row justify-center items-center relative">
      <div className="w-[100%] md:w-[100%] lg:w-[50%] xl:w-[50%] bg-[#192A36] h-[50%] md:h-[50%] lg:h-[100%] xl:h-[100%] flex flex-col justify-start items-start py-3 md:py-3 lg:py-24 xl:py-24 px-3 md:px-3 lg:px-28 xl:px-28 gap-8">
        ...
        <div className="flex flex-wrap justify-center md:justify-center lg:justify-start xl:justify-start items-center gap-x-4  my-0 md:my-0 lg:my-8 xl:my-8">
