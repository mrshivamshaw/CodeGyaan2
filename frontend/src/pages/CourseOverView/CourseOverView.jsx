...
const CourseOverView = () => {
  ...
  return (
    <div className='min-w-[100vw] min-h-[100vh] overflow-hidden'>
        <NavBar/>
        <div className='mt-28 w-[95%] md:w-[95%] lg:w-[85%] xl:w-[85%] mx-auto flex flex-col-reverse md:flex-col-reverse lg:flex-row xl:flex-row justify-between items-start gap-9 py-12'>
