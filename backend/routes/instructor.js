...
import { courseDetails, createCourse, deleteCourse, editCourse, fetchCourseByCategory, fetchInstructorCourses, getAllCourses, getFullCompleteCourse } from "../controllers/course.js";
...
instructorRoute.get('/getCourseByCategory/:category',fetchCourseByCategory);
